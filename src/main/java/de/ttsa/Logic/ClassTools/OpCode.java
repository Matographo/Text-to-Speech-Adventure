...
// ------------------------------  REGEX  ------------------------------
    ...
    protected final String REGEX_IF_INNER_BRECKETS = "(-)?(([a-zA-Z]+[\\w]*)|([\\d]))*(([\\+\\-\\*\\/]){1}(-)?(([a-zA-Z]+[\\w]*)|([\\d])))*";
    protected final String REGEX_IF_STRING         = "(([a-zA-Z]+[\\w]*)|(\"[a-zA-Z]+[\\w]*)\")((\\=\\=)|(\\!\\=))(([a-zA-Z]+[\\w]*)|(\"[a-zA-Z]+[\\w]*)\")";
    ...
    protected final String REGEX_DEBUG             = "(([a-zA-Z]\\w*)|(\"[\s]?([a-zA-Z][\\w\\s]*)?\"))(,(\"[\s]?([a-zA-Z][\\w\\s]*)?\")|,([a-zA-Z]\\w*))*";
    protected final String REGEX_EXIT              = "[0]|[1]";
    protected final String REGEX_LOOP              = "(true)|\\d+|([a-zA-Z][\\w]*)";
