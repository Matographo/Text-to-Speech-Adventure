...
public class LoopCodeVar extends StringMethods implements CodeVarTestable {
    ...
    public boolean test(String toTest, OpCodeVar opCodeVar) {
        ...
        if(toTest.contains("==")) {
            ...
            if (toTest.equals(CompilerSyntax.TRUE.toString())) {
                return true;
            } else if (toTest.matches("[a-zA-Z]+\\w*")) {
                return opCodeVar.isNumName(toTest);
            }
