...
public enum Regex {
    ...
    IF_INPUT("(~?-?\\[(-?\\{(-?(\"[\\w.,!?]*\"|'[a-zA-Z][\\w]*'|@[a-zA-Z][\\w]*@)\\*\\(\\d*\\))[&!]?(-?(\"[\\w.,!?]*\"|'[a-zA-Z][\\w]*'|@[a-zA-Z][\\w]*@)\\*\\(\\d*\\))*\\}\\*\\(\\d*\\))[!&]?(-?\\{(-?(\"[\\w.,!?]*\"|'[a-zA-Z][\\w]*'|@[a-zA-Z][\\w]*@)\\*\\(\\d*\\))[&!]?(-?(\"[\\w.,!?]*\"|'[a-zA-Z][\\w]*'|@[a-zA-Z][\\w]*@)\\*\\(\\d*\\))*\\}\\*\\(\\d*\\))*\\]\\*\\(\\d*\\))[!&]?(~?-?\\[(-?\\{(-?(\"[\\w.,!?]*\"|'[a-zA-Z][\\w]*'|@[a-zA-Z][\\w]*@)\\*\\(\\d*\\))[&!]?(-?(\"[\\w.,!?]*\"|'[a-zA-Z][\\w]*'|@[a-zA-Z][\\w]*@)\\*\\(\\d*\\))*\\}\\*\\(\\d*\\))[!&]?(-?\\{(-?(\"[\\w.,!?]*\"|'[a-zA-Z][\\w]*'|@[a-zA-Z][\\w]*@)\\*\\(\\d*\\))[&!]?(-?(\"[\\w.,!?]*\"|'[a-zA-Z][\\w]*'|@[a-zA-Z][\\w]*@)\\*\\(\\d*\\))*\\}\\*\\(\\d*\\))*\\]\\*\\(\\d*\\))*"), 
